...
(function($) {
    $.jCryption = function(el, options) {
        ...
        base.authenticate = function(token,success, failure) {
            var key = base.getKey();
            $.jCryption.authenticate(key, base.options.getKeysURL, base.options.handshakeURL,token, success, failure);
        };
    };
    ...
    $.jCryption.authenticate = function(AESEncryptionKey, publicKeyURL, handshakeURL,token, success, failure) {
        $.jCryption.getKeys(publicKeyURL, function(keys) {
            $.jCryption.encryptKey(AESEncryptionKey, keys, function(encryptedKey) {
                $.jCryption.handshake(handshakeURL, encryptedKey,token, function(response) {
